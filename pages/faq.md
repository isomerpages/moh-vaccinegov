...
and above for Moderna vaccine</p> 
    			...
    			<div class="tab">
					...
					<div class="tab">
						...
						<label class="tab-label" for="question-1-9">My child/ward turns 12 this year. Can I get him/her vaccinated?</label>
						<div class="tab-content">
							<p>
					...
					<div class="tab">
						...
						<label class="tab-label" for="question-1-10">I want to get my child/ward vaccinated. What do I need to do?</label>
						<div class="tab-content">
							<p>

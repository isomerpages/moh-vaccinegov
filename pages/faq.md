...
<div class="tabs">
				...
				<div class="tab">
					...
					<div class="tab-content">
						<p>The COVID-19 vaccines used are currently Pfizer-BioNTech/Comirnaty-BioNTech and Moderna .</p>
					</div>
				</div>
				<!-- end of each question -->
					<!-- start of each question -->
    			...
    			<div class="tab">
    				...
    				<div class="tab-content">
    					<p>The Islamic Religious Council of Singapore (MUIS) has permitted COVID-19 vaccines for Muslim use. Please refer to MUIS’ <a href="https://www.muis.gov.sg/Media/Media-Releases/13-Dec-20-Religious-Position-on-COVID-19-Vaccine" target="_blank">religious position</a> on the COVID-19 vaccine for more information.</p>
    				</div>
    			</div>
    			<!-- end of each question -->
					<!-- start of each question -->
    			<div class="tab">
    				...
    				<div class="tab-content">
    					<p>There is no evidence at this time suggesting that the Pfizer-BioNTech/Comirnaty-BioNTech and Moderna’s vaccines do not protect against specific COVID-19 strains, including the UK’s new reported variant. HSA and the EC19V are closely monitoring this issue.
							</p>
    				</div>
    			</div>
    			<!-- end of each question -->
